# BUILD-A-THON-- IOT-Based Remote Patient Monitoring System using ESP32 and Cloud Analytics-
Developed an - IOT-Based Remote Patient Monitoring System using ESP32 and Cloud Analytics using ESP32 and multiple biomedical sensors to monitor Heart Rate, SpO₂, ECG, Pulse Rate, and Glucose levels in real time. The system displays data on an OLED screen and transmits it to Blynk and Google Sheets for remote monitoring, cloud storage, and future health analysis. 
